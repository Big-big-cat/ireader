...
<!--在第一个"加入购物车"之后，有一个<a>
  <a class="... collection" ,并删除第二个class-->
    <main id="main" class="container">
      ...
      <div class="container mb-5">
        <div class="row pr-3">
          <div id="preview" class="col pr-0">
            <div class="card bg-transparent mr-5 position-absolute">
              <img class="card-img-top" :src="mImg">
              <div id="mask" class="position-absolute d-none"></div>
              <div id="super-mask" class="position-absolute"></div> 
              <div id="div-lg" class="position-absolute d-none" :style="lgDivStyle"></div>
              <div class="card-body p-0 text-center">
                <img src="img/product_detail/hover-prev.png" class="btn float-left btn-light border-0 p-1 pt-4 pb-4" :class="{disabled:!canRight}" @click="moveRight()">
                <div class="d-inline-block pt-2 mx-0 m-auto">
                  <!-- <ul class="list-unstyled mb-0"> -->
		<ul class="list-unstyled mb-0" :style="ulImgsStyle">
		  <li class="float-left p-1" v-for="p of pics">
			<img :src="p.sm" :data-md="p.md" :data-lg="p.lg">
		  </li>
		</ul>
                </div>
                <img src="img/product_detail/hover-next.png" class="btn float-right btn-light border-0 p-1 pt-4 pb-4" :class="{disabled:!canLeft}" @click="moveLeft()">
              </div>
            </div>
          </div>
		...
		<router-link v-for="sp of specs" 
     class="btn btn-sm btn-outline-secondary" :class="`${sp.lid==lid?'active':''}`" href="javascript:;" 
     :to="`/details/${sp.lid}`">
     {{sp.spec}}
    </router-link>
              </div>
            ...
            <div>
              ...
              <a class="btn btn-primary pt-3" href="javascript:;">
                <h5 @click="addCart()"><img src="img/product_detail/product_detail_img7.png" alt="" > 加入购物车</h5>
              </a>
          ...
          load(){
            ...
            "http://localhost:3000/details",
            {
              ...
              this.ulImgsStyle.width=
                  62*this.pics.length+"px";
              this.mImg=this.pics[0].md;
              this.lgDivStyle["background-image"]=this.pics[0].lg;
...
<style scoped>/*product_details.css*/
    /*定制规格参数按钮的颜色*/
